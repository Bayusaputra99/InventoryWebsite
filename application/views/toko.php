								...
								<div class="card-body">
									<form action="<?= base_url('toko/proses_ubah') ?>" id="form-tambah" method="POST">
										<div class="form-group">
											...
											<input type="text" name="nama_toko" id="nama_toko" value="<?= $toko->nama_toko ?>" onkeypress="return /[a-z]/i.test(event.key)" placeholder="Masukan Nama Toko" class="form-control" readonly>
										</div>
										<div class="form-group">
											<label for="nama_toko"><strong>Nama Pemilik : </strong></label>
											<input type="text" name="nama_pemilik" id="nama_pemilik" value="<?= $toko->nama_pemilik ?>" onkeypress="return /[a-z]/i.test(event.key)" placeholder="Masukan Nama Pemilik" class="form-control" readonly>
										</div>
										<div class="form-group">
