									...
									<form action="<?= base_url('supplier/proses_ubah/' . $supplier->kode) ?>" id="form-tambah" method="POST">
										<div class="form-row">
											...
											<div class="form-group col-md-6">
												...
												<input type="text" name="nama" placeholder="Masukkan Nama supplier" autocomplete="off" onkeypress="return /[a-z]/i.test(event.key)" class="form-control" required value="<?= $supplier->nama ?>">
											</div>
										</div>
										<div class="form-row">
