									...
									<form action="<?= base_url('petugas/proses_ubah/' . $petugas->id) ?>" id="form-tambah" method="POST">
										<div class="form-row">
											...
											<div class="form-group col-md-6">
												...
												<input type="text" name="nama" placeholder="Masukkan Nama petugas" autocomplete="off" onkeypress="return /[a-z]/i.test(event.key)" class="form-control" required value="<?= $petugas->nama ?>">
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-6">
