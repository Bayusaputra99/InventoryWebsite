									...
									<form action="<?= base_url('pengguna/proses_ubah/' . $pengguna->id) ?>" id="form-tambah" method="POST">
										<div class="form-row">
											...
											<div class="form-group col-md-6">
												...
												<input type="text" name="nama" placeholder="Masukkan Nama Pengguna" autocomplete="off" class="form-control" onkeypress="return /[a-z]/i.test(event.key)" required value="<?= $pengguna->nama ?>">
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-6">
