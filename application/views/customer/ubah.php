									...
									<form action="<?= base_url('customer/proses_ubah/' . $customer->kode) ?>" id="form-tambah" method="POST">
										<div class="form-row">
											...
											<div class="form-group col-md-6">
												...
												<input type="text" name="nama" placeholder="Masukkan Nama customer" autocomplete="off" onkeypress="return /[a-z]/i.test(event.key)" class="form-control" required value="<?= $customer->nama ?>">
											</div>
										</div>
										<div class="form-row">
